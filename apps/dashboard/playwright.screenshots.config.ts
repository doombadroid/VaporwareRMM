// Standalone config for README screenshot capture. By default boots
// its own server + dashboard on isolated ports (3033 / 8093) to avoid
// colliding with locally running dev stacks.
//
// To capture against an already-running stack (e.g. one that has been
// pre-populated with sample data), set SHOTS_USE_RUNNING=1. The
// existing servers must be reachable at the same ports (3033 / 8093).
//
...
const useRunning = process.env.SHOTS_USE_RUNNING === '1'
